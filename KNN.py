...
def perform_knn_grid_search(X_train, y_train):
    ...
    param_grid = {
        'classifier__n_neighbors': [3, 5, 7, 9, 11, 13, 15, 19], 
...
def main():
    ...
    best_knn_model = perform_knn_grid_search(X_train, y_train)
    
    train_evaluate_model(best_knn_model, X_train, X_test, y_train, y_test, model_name="Tuned KNN (Math)")
